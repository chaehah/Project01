                                    ...
                                    <tbody>
										<c:forEach var="manager" items="${managerList}" varStatus="idx">
											<tr>
												...
												<%-- <td><a href="content.do?userNum=${manager.managerNo}">${manager.managerId}</a></td> --%>
												<td>${manager.managerId }</td>
												<td>${manager.managerName }</td>
												<td>${manager.managerEmail }</td>
												<td>${manager.managerPhone }</td>
												<td>${manager.managerFlag }</td>
												<td>${manager.managerAdminFlag }</td>
